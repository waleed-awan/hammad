...
export default function VehicleSelector() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-16 bg-gradient-to-b from-[#001a1d]/70 to-[#002f31]/90 backdrop-blur-sm text-white">
          ...
          {vehicles.map((v, index) => {
            ...
            return (
              <div
                ...
                className={`absolute w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center bg-white/90 opacity-60 backdrop-blur-sm transition-all duration-300 cursor-pointer ${
                  isActive
      ...
      {/* FORM SECTION */}
      <div
        className="relative border border-gray-700 rounded-2xl max-w-3xl w-full p-8 shadow-lg overflow-hidden"
        style={{
          backgroundImage: "url('/bg-form.jpg')", // replace with your image
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#001a1d]/70 to-[#002f31]/90 backdrop-blur-sm"></div>
